 ...
 */
package com.freetux.PRSMS.repository
...
import com.freetux.PRSMS.common.util.extensions.now
import com.freetux.PRSMS.compat.TelephonyCompat
import com.freetux.PRSMS.extensions.anyOf
...
import com.freetux.PRSMS.util.ImageUtils
...
class MessageRepositoryImpl @Inject constructor(
    ...
    override fun savePart(id: Long): File? {
        ...
        val dir = File(Environment.getExternalStorageDirectory(), "PRSMS/Media").apply { mkdirs() }
