 ...
 */
package com.freetux.PRSMS.common.base
...
import com.freetux.PRSMS.common.util.extensions.resolveThemeBoolean
...
abstract class QkThemedActivity : QkActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val triggers = listOf(prefs.nightMode, prefs.night, prefs.black, prefs.textSize, prefs.systemFont, prefs.shamsiDate)
