...
class Navigator @Inject constructor(
    ...
    /**
     * @param source String to indicate where this PRSMS+ screen was launched from. This should be
     * one of [main_menu, compose_schedule, settings_night, settings_theme]
     */
    fun showQksmsPlusActivity(source: String) {
        analyticsManager.track("Viewed PRSMS+", Pair("source", source))
    ...
    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.freetux.PRSMS"))
