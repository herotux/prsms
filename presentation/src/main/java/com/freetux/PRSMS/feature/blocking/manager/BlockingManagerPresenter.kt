...
import com.freetux.PRSMS.blocking.CallBlockerBlockingClient
import com.freetux.PRSMS.blocking.CallControlBlockingClient
import com.freetux.PRSMS.blocking.QksmsBlockingClient
import com.freetux.PRSMS.blocking.ShouldIAnswerBlockingClient
...
class BlockingManagerPresenter @Inject constructor(
    ...
    override fun bindIntents(view: BlockingManagerView) {
        ...
        view.qksmsClicked()
                ...
                .autoDisposable(view.scope())
                .subscribe {
                    analytics.setUserProperty("Blocking Manager", "PRSMS")
